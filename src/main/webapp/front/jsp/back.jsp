...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-left">
			...
			<li class="layui-nav-item"><a href="<%=jspPath+"updoc.jsp"%>" target="myiframe">我要上传</a></li>
			<li class="layui-nav-item"><a href="<%=jspPath+"backtable.jsp"%>" target="myiframe">用户管理</a></li>
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item"><a href="<%=jspPath+"welcome.jsp"%>">注销</a></li>
		</ul>
	</div>
	...
	<div class="layui-body">
		<!-- 内容主体区域 -->
		<iframe frameborder="0" name="myiframe" id="myiframe" style="width: 100%;height: 100%"></iframe>
	</div>
